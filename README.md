...
ApkFile is a library which creates a representation of an APK composed of Java objects which can be easily inspected for analysis or deserialized to JSON. The goal of the library is to provide a robust way to inspect hostile malware samples, but it's general purpose enough to be used for other stuff too.
